...
\section{Introdução}
    ...
    \begin{proof}[Prova do Teorema da Dicotomia]
        ...
        Seja uma escatologia $\epsilon_i, i \in \{1, 2, 3,  \ldots\}$  qualquer  (em  que  o  índice  $i$  numera-a,
        identificando-a de forma única e inequívoca).

        Caso  (i)~$\epsilon_i$  incorra  em  erro  (contenha  erro),  será,  pela   Definição~\ref{def.esc.comerro},
        escatologia ``com erro.'' Neste caso, tal escatologia também não poderá ser \bQuote{segundo Deus}, pois está
        escrito:
    ...
    aquela\footnote{Adianto-me  aqui,  quanto  à  unicidade  da  escatologia  \bQuote{segundo  Deus},  meramente  para  fazer  o
    argumento.}, \bQuote{segundo Deus}, que \textbf{deve ser guardada} e também \emph{crida, ensinada e proclamada}.
