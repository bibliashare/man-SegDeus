...
\section{Algumas Implicações}
    ...
    constituem-se em \emph{promessas} nas quais é justiça esperar, as quais, a seu devido tempo, fielmente \emph{cumprir-se-ão},
    ...
    Agora que os princípios bíblicos estão identificados e embasados nas Escrituras, desenha-se algumas implicações, uma vez que
...
\section{Generalização Para Qualquer Doutrina Bí\-bli\-ca}
    ...
    \begin{proof}[Prova do Teorema da Dicotomia Doutrinária]
        ...
        justiça    e    retidão    procedentes    da    verdade}{Ef~2.24}{ARA}    e     será,     portanto,     pela
        Definição~\ref{def.dou.segDeus}, uma doutrina \bQuote{se\-gun\-do\pagebreak{} Deus}.
