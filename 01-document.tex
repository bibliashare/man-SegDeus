...
\section{Princípios Bíblicos Para Escatologia ``Segundo Deus''}
    ...
    o espaço-tempo dos \bQuote{céus e terra} possui \textbf{unicidade}, ao invés de `multiversos' ou `realidades' paralelas.

    Está demonstrado, então, pelas Escrituras, a \emph{unicidade da realidade do princípio ao fim}, de onde se extrai:

    % !j 116 -i8
    \begin{DEF}[Princípio da Unicidade da Realidade do Princípio ao Fim]
    ...
    % !j 116 -i8
    \begin{DEF}[Princípio da Veracidade das Profecias Divinas]
    ...
    % !j 116 -i8
    \begin{DEF}[Princípio da Equivalência Entre Profecias e Promessas Divinas]
    ...
    A profecia é solene, tal que Deus continua:
        ...
        \bBlockQuote{% !j -i12 116
            ...
            Porém o profeta que \textbf{presumir de falar alguma palavra em meu nome, que eu lhe não mandei  falar},
            ou o que falar em nome de outros deuses, esse profeta \textbf{será morto}.}{Dt~18.19,20}{ARA}
