...
\section{Introdução}
    ...
    qualquer assunto da Palavra de Deus), por parte de quem ande por fé em Jesus  Cristo,  de  forma  a  chegar  nas  conclusões
    verdadeiras, no sentido verdadeiro das profecias, entendido como coincidindo com o que \emph{Deus tem resolvido no  Conselho
    de Sua vontade}, com o que \emph{realmente acontecerá}, pois a Escritura testifica, por meio de Moisés:

        \bBlockQuote{% !j -i12 116
            Porque este mandamento que, hoje, te ordeno não é demasiado difícil, nem está longe de ti. Não está nos céus, para
            dizeres: Quem subirá por nós aos céus, que no-lo traga e no-lo faça ouvir, para que o cumpramos? Nem está além do
            mar, para dizeres: Quem passará por nós além do mar que no-lo traga e no-lo faça ouvir, para que o cumpramos? Pois
            esta palavra está mui perto de ti, na tua boca e no teu coração, para a cumprires.}{Dt~30.11-14}{ARA}

    Passa-se, então, à \emph{definição} de escatologia ``segundo Deus,'' ou, de estudo de profecias ``segundo Deus:''

    % !j 116 -i8
    \begin{DEF}[Escatologia ``Segundo Deus'']
        \label{def.esc.segDeus}
        Seja a escatologia \bQuote{segundo Deus} aquela feita ``à maneira de Deus,'' aquela que, baseada  unicamente
        em verdade, é conduzida em retidão e chega à verdade, a saber, aquela  feita  \bLineQuote{segundo  Deus,  em
        justiça e retidão procedentes da verdade}{Ef~2.24}{ARA}\footnote{A expressão  \bQuote{segundo  Deus}  também
    ...
    % !j 116 -i8
    \begin{DEF}[Escatologia Enganosa]
    ...
    ``meio-termo,'' significando que para uma dada escatologia, ou ela é \bQuote{segundo Deus} ou  ela  é  enganosa,  pois  está
    escrito:
    ...
    proféticos  \bQuote{segundo  Deus},  são   mais   imediatamente   aplicáveis,   e,   portanto,   desejáveis,   do   que   as
