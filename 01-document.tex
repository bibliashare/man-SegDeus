...
\section{Princípios Bíblicos Para Escatologia ``Segundo Deus''}
    ...
    estar cientes da (i)~natureza progressiva da revelação, e que, (ii)~em cada época, as referências empregadas  serviram  para
    entendimento   dos   ouvintes,   \emph{à    época}!    Pois,    \bLineQuote{Na    verdade,    \textbf{Deus    não    procede
