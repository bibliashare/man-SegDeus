...
\section{Introdução}
    ...
    \begin{DEF}[Escatologia Com Erro]
        ...
        Seja a escatologia com erro, aquela que incorre em erro, seja em  suas  premissas,  métodos,  processos,  ou
        conclusões.
    \end{DEF}
    ...
    Deus}, que \textbf{deve ser guardada} e também \emph{crida, ensinada e propagada}.

    As Definições~\ref{def.esc.segDeus}  e~\ref{def.esc.comerro}  dadas,  no  entanto,  não  são  necessariamente  de  fácil  ou
    consensual aplicação, especialmente em um cenário --- o atual --- no qual proliferam, não apenas diferentes visões de mundo,
    mas igualmente, erros grosseiros nas diferentes abordagens escatológicas.

    De  um  ponto  de  vista  prático,  a  existência  de  \emph{princípios  mais  facilmente   verificáveis},   e   que   sejam
