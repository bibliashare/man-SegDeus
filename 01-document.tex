...
\section{Princípios Bíblicos Para Escatologia ``Segundo Deus''}
    ...
    % !j 116 -i8
    \begin{PRI}[Princípio da Unicidade da Realidade do Princípio ao Fim]
            \label{pri.unicidade}
    ...
    % !j 116 -i8
    \begin{PRI}[Princípio da Veracidade das Profecias Divinas]
    ...
    % !j 116 -i8
    \begin{PRI}[Princípio da Equivalência Entre Profecias e Promessas Divinas]
    ...
    % !j 116 -i8
    \begin{PRI}[Princípio da Verificabilidade Das Profecias Divinas]
    ...
    % !j 116 -i8
    \begin{PRI}[Princípio da Vigilância Divina à Sua Palavra]
    ...
    % !j 116 -i8
    \begin{PRI}[Princípio do Cumprimento Como Profetizado]
        \label{pri.comoprof}
    ...
    como profetizado} --- afinal, tais são exemplos de \bQuote{palavra que o Senhor \textbf{não disse}}; assim, alegar, para uma
    profecia, cumprimento com sentido diferente de como foi profetizada ou enunciada, é típica manipulação  maliciosa  que  cabe
    senão a criaturas incapazes de prever acertadamente o futuro; porém tal jamais cabe a Deus e a profecias de Deus!
