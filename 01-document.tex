...
\begin{abstract}
    ...
    deste estudo contribuam para a unificação da escatologia bíblica \bLineQuote{segundo Deus, em justiça e retidão  procedentes
    da verdade}{Ef~4.24}{ARA}.
\end{abstract}

\input{01.1-abstract-en.tex}
...
\section*{Licença}
    ...
    \begin{minipage}{\columnwidth}
        ...
        {\scriptsize\texttt{https://creativecommons.org/licenses/by/4.0/}}
    \end{minipage}
    \normalsize
...
\section{Introdução}
    ...
    Percebe-se  um  abismo  entre   aquilo   que   as   Escrituras   Sagradas   revelam   acerca   do   \bLineQuote{único   Deus
    ...
    verdade e engano, no qual o engano parece estar colhendo do muito que semeou ao longo dos séculos.
    ...
    mutuamente incompatíveis e irreconciliáveis \emph{não é fruto da ação exclusiva de Deus no corpo}, porém, também do  inimigo
    de nossas almas por meio de homens de artimanha, os quais com astúcia induzem ao erro, conforme o que está escrito:
    ...
    Tem-se em mente uma abordagem escatológica \bQuote{segundo Deus}\footnote{A expressão \bQuote{segundo Deus}  também  aparece
    em 1Pe~4.6 e três vezes em 2Co~7.9-11.}, feita ``à maneira de Deus;'' aquela que, baseada unicamente em verdade, é conduzida
    em retidão e chega a conclusões verdadeiras com relação às profecias bíblicas, a saber, ao que o próprio Deus tem  reservado
    para o futuro e vem anunciando desde o princípio, e irá cumprir e acontecer:
    ...
    Passa-se também à definição de escatologia ``com \emph{erro}'' --- aqui, ``erro'' é entendido como \emph{qualquer  violação}
    de \emph{qualquer um ou mais} preceitos das Escrituras --- ou escatologia com engano, ou enganosa, que não é \bQuote{segundo
    Deus}:
    ...
    A presente abordagem, de proposições,  teoremas  e  provas,  mais  comumente  empregada  nas  Ciências  Exatas,  porém  aqui
    incipientemente aplicada à Teologia, ilustra como a Teologia Bíblica --- por basear-se na verdade  das  Escrituras  Sagradas
    (conforme o Axioma~3 abaixo) e assim, possuir inigualável âncora de verdade --- não apenas pode, mas deveria empregar,  mais
    extensivamente, a abordagem exata, pelo dom de Cristo, por exemplo, na falsificação cabal  das  muitas  heresias  que  foram
    sendo propostas ao longo dos séculos.
    ...
    escopo, e não do teor, meramente para fazer o argumento.}, \bQuote{segundo Deus}, que \textbf{devem ser guardadas} e  também
    \emph{cridas, ensinadas e proclamadas}.
    ...
    exaustiva}, podendo ser focada em um dado subconjunto de escatologias sob análise, e podendo ser complementada em estudos  e
    ...
    bíblicos} que sejam, por definição e de fato, \emph{indispensáveis} a estudos proféticos  e  a  escatologia  \bQuote{segundo
    Deus}, com vistas à exposição de erros em escatologias, podendo classificá-las cabal e inequivocamente  como  ``escatologias
    com erro,'' de acordo com Definição~\ref{def.esc.comerro} dada, fornecendo, assim,  os  aludidos  \textsc{instrumentos  para
    comprovação de escatologias ``com erro''}.
...
\section{Princípios Bíblicos Para Escatologia ``Segundo Deus''}
    ...
    No trato de Deus com Abrão, Deus fez-lhe várias afirmações acerca do futuro; portanto, Deus profetizou-lhe coisas
    concernentes à sua descendência:

        \bBlockQuote{% !j -i12 116
            A isto respondeu logo o Senhor , dizendo: Não será esse o teu  herdeiro;  mas  \textbf{aquele  que  será
            gerado de ti será o teu herdeiro}. Então, conduziu-o até fora e disse: Olha para  os  céus  e  conta  as
            estrelas, se é que o podes. E lhe disse: \textbf{Será assim a tua posteridade}.}{Gn~15.4,5}{ARA}

    A Escritura declara, depois:

        \bBlockQuote{% !j -i12 116
            E assim, depois de esperar com paciência, obteve A\-bra\-ão a \textbf{promessa}.}{Hb~6.15}{ARA}
 
    A veracidade das profecias divinas implica na certeza de seu cumprimento, portanto \emph{as profecias divinas são  promessas
    divinas}, nas quais é justiça esperar --- \bLineQuote{É o caso de Abraão, que creu em Deus, e isso  lhe  foi  imputado  para
    justiça.}{Gl~3.6}{ARA}.
    ...
    E também:
        ...
        \bBlockQuote{% !j -i12 116
            ...
            \textbf{profecia}   e   \textbf{guardam}   as   coisas   nela    escritas,    pois    o    tempo    está
            próximo.}{A\-po\-ca\-li\-pse~1.3}{ARA}
    ...
    saber, as \bLineQuote{coisas que ainda não sucederam}{Is~46.10}{ARC}, uma vez chegado seu tempo e cumpridas, podem ser assim
    ...
    E em seguida:
        ...
        \bBlockQuote{% !j -i12 116
            ...
            dos profetas}: Ele será chamado Nazareno.}{Ma\-teus~2.23}{ARA}
    ...
    Note-se que `velar' significa: ``permanecer de vigia,  de  sen\-ti\-ne\-la''~\cite{2009-Houaiss+Franco-Objetiva}.  Assim,  o
    Deus que está \bLineQuote{sustentando todas as coisas pela palavra do seu poder}{Hb~1.3}{ARA}, que \bQuote{é antes de  todas
    as coisas} e no qual \bLineQuote{tudo subsiste}{Cl~1.17}{ARA}, permanece de sentinela para \textbf{cumprir} Sua Palavra!
    ...
    O termo \bQuote{Sabe que} é para dar \emph{certeza plena no assunto!}  O  v.~22  revela  qual  é  a  palavra  que  o  Senhor
    \bQuote{não disse} --- a saber, aquela que \bQuote{se não cumprir, nem suceder, como profetizou}.
    ...
    Foi profetizado \bQuote{em cuja boca porei as minhas palavras}, e cum\-priu-se \bQuote{As palavras que eu vos  digo  não  as
    digo por mim mesmo}, ou seja, \textbf{cumpriu-se como profetizado}!

    E ainda, com relação ao que antes foi profetizado \bQuote{ele lhes falará tudo o que eu lhe ordenar}, temos  o  registro  do
    ...
    isso com profecias divinas, em violação das Escrituras (através do Corolário~\ref{def.cor.alegorico}),  é  blasfêmia  contra
    Deus, ao reduzi-Lo ao patamar de falso profeta.
    ...
    dias de tua vida}{Gn~3.17}{ARA}, observamos uma \emph{forte tradição oral entre os descendentes de Adão}, pois Lameque  diz,
    ...
    empregar \emph{nossas} definições, ao invés das de Deus, para termos-chave que aparecem depois, e assim \emph{errar, estando
    presumidos em nós mesmos}, sem identificar a referência bíblica que está sendo feita ``segundo Deus.''
    ...
    Ora, o princípio da tradição de Deus é bíblico, pois Deus, através de Paulo, diz:
        ...
        \bBlockQuote{% !j -i12 116
            ...
            paciência e pela consolação das Escrituras, tenhamos esperança.}{Ro\-ma\-nos~15.4}{ARA}

    Aqui cabe acrescentar algo importante, para nós, que,  diferentemente  de  outras  épocas,  temos  \emph{acesso}  a  toda  a
    revelação, com os 66 livros da Bíblia: folhear a Bíblia é também `viajar no tempo' e, tendo toda a Bíblia em  mãos,  devemos
    estar cientes da (i)~natureza progressiva da revelação, e que, (ii)~em cada época, as \emph{referências empregadas} eram  de
    acordo com a \emph{revelação disponível} aos ouvintes, \emph{à época}\footnote{Revelação \emph{disponível} não significa que
    será necessariamente bem \emph{compreendida}! O contra-exemplo sendo parábolas de Deus para que ouvintes, que já endureceram
    o próprio coração, \emph{não entendam} o que se fala, por motivo de \emph{juízo}, justamente em cumprimento de profecia,  de
    acordo com Mateus~13.13--16!}!

    Em razão de tal dependência das Escrituras para o entendimento \bQuote{segundo Deus} das  Escrituras,  enuncia-se,  então  o
    seguinte princípio:
    ...
    Escrituras elucidativas mostram que a Palavra elucidativa de Deus é direcionada, primeiramente, à  sua  audiência  original:
    \bLineQuote{Tendo Jesus concluído todas as suas palavras \emph{dirigidas ao povo}, entrou  em  Cafarnaum.}{Lc~7.1}{ARA},  e:
    \bLineQuote{Palavra do Senhor que foi \emph{dirigida a Joel}, filho de Petuel.}{Jl~1.1}{ARA}.
    ...
    \begin{PRI}[do Direcionamento da Palavra de Deus]
        ...
        Escrituras elucidativas são primeiramente direcionadas à sua audiência original, de acordo com a revelação a
        ela disponível.
    \end{PRI}

    As Escrituras \emph{elucidativas} são aquelas dadas com a \emph{intenção de revelar}, em oposição a ``palavras seladas'' e a
    palavras de juízo, como parábolas, de acordo com Mateus~13.13--16!
...
\section{Algumas Implicações}
    ...
    \bQuote{segundo Deus}, usa-se `buscar', uma vez que não se arroga aqui tê-lo alcançado.} estudar profecia ``segundo  Deus,''
    \emph{requer} reconhecer que Deus tem um plano \emph{único} e estabelecido, segundo o conselho  de  Sua  vontade,  que  este
    plano é \emph{verdadeiramente} revelado nas Escrituras, as quais, vindas de um Deus  fiel  e  verdadeiro,  constituem-se  em
    \emph{promessas} nas quais é justiça esperar, as quais, a seu devido  tempo,  fielmente  \emph{cumprir-se-ão},  tal  que  no
    futuro serão \emph{verificadas}, que aconteceram e sucederam \emph{como profetizado} por  um  Deus  fiel  e  verdadeiro  que
    \emph{intenta o que diz} em sua revelação progressiva, que \emph{nos ensina do início ao fim}.

    Agora que alguns princípios bíblicos estão identificados e embasados nas Escrituras, desenha-se algumas implicações, uma vez
    que a violação dos princípios bíblicos constitui instrumento inequívoco e cabal para comprovação de escatologias  com  erro,
    como discutido anteriormente, de imediato, reconhece-se as seguintes implicações:
...
\section{Conclusão}
    ...
    sendo parte de um único, são e coeso ensino \bQuote{segundo Deus}.

    Além das definições, foi proposto (i)~\emph{identificar} e (ii)~\emph{enunciar} princípios bíblicos indispensáveis a estudos
    \bQuote{segundo Deus} de profecias bíblicas, deduzidos à partir das Escrituras, sob os axiomas  de  que  as  Escrituras  são
    verdade e Palavra do único Deus verdadeiro. Foi arguido e demonstrado que tais princípios bíblicos podem ser empregados como
    \textsc{instrumentos para comprovação de escatologias ``com erro''}, capazes  de  qualificar  e  expor,  cabalmente  o  erro
    incorrido por uma dada escatologia sob análise.
    ...
    Implicações imediatas (1)~quanto ao atual e lamentável  estado  de  tolerância  à  multiplicidade  de  visões  escatológicas
    mutuamente irreconciliáveis; (2)~quanto às linhas de interpretação alegóricas de profecias, e  (3)~àquelas  que  recorrem  a
    passagens futuras para explicar termos-chave empregados em passagens anteriores foram feitas, sem exaustão.

    Finalmente, crê-se também que \emph{qualquer} estudo Bíblico feito \bQuote{se\-gun\-do Deus} levará à \emph{unidade da fé} a
    que somos exortados pelas Escrituras; pois que, conduzidas pelo Espírito que \bLineQuote{dá testemunho, porque o Espírito  é
    a verdade. E três são as testemunhas: o Espírito, a água e o sangue, e os três concordam.}{1Jo~5.7,8}{PESH}.
...
\section{Generalização Para Qualquer Doutrina Bí\-bli\-ca}
    ...
    Tendo-se em mente abordagens bíblicas doutrinárias \bQuote{se\-gun\-do\linebreak{} Deus}, à semelhança e em generalização do
    ...
    Passa-se também à definição de doutrina ``com \emph{erro},'' ou doutrina com engano, ou enganosa, que não é segundo Deus:
    ...
    \begin{proof}[Prova do Teorema da Dicotomia Doutrinária]
        \label{pro.the.dou.dicotomia}
        Seja uma doutrina $\delta_i$\linebreak{} qual\-quer, com $i \in \{1, 2, 3,  \ldots\}$.  Caso  (i)~$\delta_i$
        incorra em erro (contenha erro), será, pela  Definição~\ref{def.dou.comerro},  uma  doutrina  ``com  erro.''
        Neste caso, tal doutrina \emph{não poderá} ser \bQuote{segundo Deus}, pois está escrito:  \bLineQuote{porque
        \textbf{mentira     alguma     jamais     procede     da      verdade}}{1Jo~2.21}{ARA},      violando      a
        Definição~\ref{def.dou.segDeus}, pelo erro jamais proceder da verdade.  Caso  (ii)~$\delta_i$  não  contiver
        erro, não incorrer em erro, terá sido feita \bLineQuote{segundo Deus, em justiça e  retidão  procedentes  da
        verdade}{Ef~2.24}{ARA}   e   será,   portanto,   pela    Definição~\ref{def.dou.segDeus},    uma    doutrina
        \bQuote{se\-gun\-do\pagebreak{} Deus}. Neste caso, tal doutrina não poderá ser ``com erro,'' pois a premissa
        de não conter erro viola a Definição~\ref{def.dou.comerro}.
    \end{proof}
    \end{minipage}

    % !j 116 -i8
    \begin{COR}
        \label{cor.dou.dicotomia.1}
        Nenhuma doutrina pode ser simultaneamente \bQuote{segundo Deus} e ``com erro.''
    \end{COR}

    % !j 116 -i8
    \begin{COR}
        \label{cor.dou.dicotomia.2}
