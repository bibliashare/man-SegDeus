...
\section{Introdução}
    ...
    \GRtxt{ἔσχατος}, que, segundo Bailly\footnote{\FRtxt{Qui est à l'extrémité, extrème, dernier ... \textbf{II} (avec  idée  de
    temps): ... dernier}.}, significa: ``\textit{o que está na extremidade, no extremo, no final; tanto  nos  sentidos  espacial
    quanto temporal; portanto: as últimas  coisas\/}''~\cite[pp.~817-8]{2000-BaillyA-Hachette}  juntamente  com  \GRtxt{-λογία}:
    ...
    conclusões a que chegam os diferentes estudos, os quais, supostamente, empregaram as mesmas Escrituras como base.

    Ao contemplar \bLineQuote{o único Deus verdadeiro}{Jo~17.3}{ARA} e santo, revelado  nas  Escrituras,  contrastando-O  com  o
